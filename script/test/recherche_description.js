...
function filtreBarreV1() {
    const inputBarre = "Mélanger le sucre la poudre d'amander";
    let resultat = [];
    recettes = recipes;
...
suite
    ...
    .add('Rechrech sans les fonction de tableu', () => {
        filtreBarreV1()
    })
    .add('Recherche avec les fonction de tableu ', () => {
        filtreBarreV2()
    })
    .on('cycle', event => {
